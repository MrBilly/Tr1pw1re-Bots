                ...
                cgb.CreateCommand(Prefix + "rules")
                    .Do(async e =>
                    {
                        ...
                        await e.Channel.SendMessage(""
                            ...
                            + "• Any bot spamming and/or aiming to use bots to earn levels from Mee6 is bannable\n"
                            + "• Any message asking for roles or permissions will be denied and/or ignored, roles are to be earned by trust and responsibility\n"
