...
namespace EvolvaBot.Classes.JSON
{
...
<https://github.com/Kwoth/EvolvaBot/blob/master/commandlist.md>
Nadeko Support Server: <https://discord.gg/0ehQwTK2RBjAxzEY>";
    ...
    /*public static class ConfigHandler
    {
        ...
        public static void SaveConfig()
        {
            lock (configLock)
            {
                File.WriteAllText("data/config.json", JsonConvert.SerializeObject(EvolvaBot.Config, Formatting.Indented));
            }
        }
        ...
        public static bool IsServerBlacklisted(ulong id) => EvolvaBot.Config.ServerBlacklist.Contains(id);

        public static bool IsChannelBlacklisted(ulong id) => EvolvaBot.Config.ChannelBlacklist.Contains(id);

        public static bool IsUserBlacklisted(ulong id) => EvolvaBot.Config.UserBlacklist.Contains(id);
    }*/
